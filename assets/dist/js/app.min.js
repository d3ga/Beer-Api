...
class BeerAPI{constructor(){this.apiUrl="https://api.punkapi.com/v2/beers"}searchByName(e,s){const r=this.apiUrl,t={beer_name:e};$.getJSON(r,t).done(e=>{s(e)}).fail(e=>{s(null)})}}class BeerSearch{constructor(){this.BeerAPI=new BeerAPI,this.elements={form:$("#search-form"),input:$("#search-input"),results:$("#results")},this.registerEvents()}registerEvents(){this.elements.form.on("submit",e=>{e.preventDefault();const s=this.elements.input.val().trim();this.BeerAPI.searchByName(s,e=>{this.showResults(e),console.log(e)})})}showResults(e){this.elements.results.html(""),0===e.length?this.showError("I am sorry but this beer was not found in the database"):($("#error").remove(),e.forEach(e=>{this.elements.results.append(`\n           <div class="card mb-3">\n              <div class="card-body">\n                <h4 class="card-title">${e.name}</h4>\n                <p class="card-text">${e.description}</p>\n             </div>\n          </div>\n        `)}))}showError(e){let s=$("#error");0===s.length&&(this.elements.form.before('<div class="alert alert-info" id="error"></div>'),s=$("#error")),s.text(e)}}const beerForm=new BeerSearch;